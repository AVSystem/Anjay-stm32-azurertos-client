...
sbsfu_ns_init=$userAppBinary"/sbsfu_ns_init"$ver".bin"
sbsfu_s_init=$userAppBinary"/sbsfu_s_init"$ver".bin"
sbsfu_ns_sign=$userAppBinary"/sbsfu_ns_sign"$ver".bin"
sbsfu_s_sign=$userAppBinary"/sbsfu_s_sign"$ver".bin"
sbsfu_s_enc_sign=$userAppBinary"/sbsfu_s_enc_sign"$ver".bin"
sbsfu_ns_enc_sign=$userAppBinary"/sbsfu_ns_enc_sign"$ver".bin"
# variable for image_number = 1
sbsfu_init=$userAppBinary"/sbsfu_init"$ver".bin"
sbsfu_enc_sign=$userAppBinary"/sbsfu_enc_sign"$ver".bin"
sbsfu_sign=$userAppBinary"/sbsfu_sign"$ver".bin"
sbsfu=$userAppBinary"/sbsfu.bin"

# field updated with sbsfu_sbsfu_boot postbuild
image_ns_size=0xa6000
image_s_size=0x6000
primary_only=0
image_number=1
crypto_scheme=0
...
sbsfu_s=$projectdir"/../../SBSFU_Secure_App/STM32CubeIDE/Release/SBSFU_Appli_Secure.bin"
sbsfu_ns=$projectdir"/Anjay-stm32-azurertos-client-B-U585I-IOT02A-BG96.bin"
